 ...
 * @version 2.0
 */
public class BinIn4in extends Gate {
	...
	// up de droite
	Rectangle rect2 = new Rectangle(39, 32, 15, 15);
	// down de gauche
	//Rectangle rect3 = new Rectangle(27, 67, 15, 15);
	// down de droite
	Rectangle rect4 = new Rectangle(39, 67, 15, 15);
...
/*		if (rect1.contains(dx, dy)) {
		...
		if (rect2.contains(dx, dy))  { // appui de up de droite
			value += 1;
		} 
		...
		if (rect4.contains(dx, dy)) {	// appui sur down drote
			System.out.println(value);	
			value -= 1;
			System.out.println(value);	
		}
	...
	public void draw(Graphics2D g) {
		...
		// draw triangles
		Rectangle rect = rect2.getBounds();
	...
	public void loadLanguage() {
		I18N.addGate(I18N.ALL, type, I18N.TITLE, "Binary Input 4 inputs");
