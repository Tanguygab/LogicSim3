...
public class Pin extends CircuitPart {
	...
	public void draw(Graphics2D g2) {
		...
		if (levelType == INVERTED) {
			...
			{
				g2.drawLine(x + offset - ovalSize - 1, y - 2 - ovalSize,x+offset, y - 2 + ovalSize / 2);
				g2.drawLine(x + offset - ovalSize - 1, y - 2 + ovalSize / 2,x+offset, y - 2 + ovalSize / 2);
			}
				//g2.drawOval(x + offset - ovalSize - 1, y - 1 - ovalSize / 2, ovalSize + 1, ovalSize + 1);
			else if (paintDirection == RIGHT)
				{
				g2.drawLine(x+offset+ ovalSize, y - 2 - ovalSize,x+offset-2, y - 2 + ovalSize / 2);
				g2.drawLine(x + offset + ovalSize, y - 2 + ovalSize / 2,x+offset-2, y - 2 + ovalSize / 2);
				}
				//g2.drawOval(x + offset, y - 1 - ovalSize / 2, ovalSize + 1, ovalSize + 1);
			else if (paintDirection == DOWN)
				{
				g2.drawLine(x, y-3, x + offset - 7,y + ovalSize);
				g2.drawLine(x, y-3,x,y + ovalSize);
				}
				//g2.drawOval(x + offset + 2 - ovalSize, y + 2 - ovalSize / 2, ovalSize + 1, ovalSize + 1);
			else // UP
				{
				g2.drawLine(x+8, y-6, x,y+2);
